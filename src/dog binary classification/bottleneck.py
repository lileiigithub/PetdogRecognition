...
top_model_weights_path = 'save/bottleneck.h5'
...
def save_bottlebeck_features():
    ...
    generator = datagen.flow_from_directory(
        ...
        class_mode=None,
        shuffle=False)
    bottleneck_features_validation = model.predict_generator(generator,nb_validation_samples // batch_size+1)
...
def train_top_model():
    ...
    # x = Dropout(0.2)(x)
    x = Dense(512, activation='relu',name='bottleneck_100_2')(x)
    x = Dropout(0.2)(x)
