...
bottleneck_features_train_path = "bottleneck_features/bottleneck_features_train_vgg19.npy"
bottleneck_features_validation_path = "bottleneck_features/bottleneck_features_validation_vgg19.npy"
...
def save_bottlebeck_features():
    ...
    validtion_generator = datagen.flow_from_directory(
        validation_data_dir,
        target_size=(img_width, img_height),
        batch_size=batch_size,
        class_mode=None,
        shuffle=False)
    bottleneck_features_validation = model.predict_generator(validtion_generator, nb_validation_samples // batch_size+1)
